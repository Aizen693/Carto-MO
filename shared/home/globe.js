...
function DateRangePopup({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "cal-title"
  }, MOIS[vm - 1], " ", vy), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "cal-nav",
    onClick: () => shift(1),
  ...
  }, JOURS.map((j, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    ...
    type: "button",
    className: "cal-btn cal-btn--go",
    disabled: !(from && to),
    onClick: () => onApply({
      from,
      to,
      label: fmt(from) + ' – ' + fmtFull(to)
    })
  }, "Valider"))));
}
function Globe() {
  ...
  const [sel, setSel] = useStateGlobe({
    entry: null,
    dateFrom: null,
    dateTo: null,
    dateLabel: null,
  ...
  useEffectGlobe(() => {
    if (logged && stage === 1 && sel.entry && !sel.dateFrom) setShowCal(true);else if (stage !== 1) setShowCal(false);
  ...
  const STAGE_EX = {
    ...
    event: ['Attaque', 'Embuscade', 'IED / Explosif'],
    actor: ['GSIM', 'EI-S', 'FAMA']
  };
  ...
  function stageOptions(st) {
    const e = sel.entry;
    if (st === 'pays') return manifest.map(c => ({
      value: c.name,
      label: c.name,
      meta: c.count + ' rens.'
    }));
    ...
    }].concat((e.months || []).map(m => ({
      value: m.key,
      label: m.label
    })));
    if (st === 'event') return [{
      value: '__all',
      label: 'Toutes les typologies'
    }].concat((e.events || []).map(v => ({
      value: v,
      label: v
    })));
    if (st === 'actor') return [{
  ...
  function matchOption(q) {
    ...
    if (!nq) return curStage === 'pays' ? null : {
      value: '__all'
    };
  ...
  function pick(opt) {
    ...
    if (curStage === 'pays') {
      ...
      setSel(s => ({
        ...s,
        event: opt.value === '__all' ? null : opt.value
      }));
      setStage(3);
    } else if (curStage === 'actor') {
      goToMap({
        ...sel,
        actor: opt.value === '__all' ? null : opt.value
      });
    }
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    title: "Modifier",
    role: "button"
  }, sel.entry.name), logged && stage > 1 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    className: "gsb-sep",
    "aria-hidden": "true"
  }, "\xB7"), /*#__PURE__*/React.createElement("span", {
    className: "gsb-val",
    onClick: () => removeChip(1),
    title: "Modifier",
    role: "button"
  }, sel.dateLabel || 'Toute période')), logged && stage > 2 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    className: "gsb-sep",
    "aria-hidden": "true"
  }, "\xB7"), /*#__PURE__*/React.createElement("span", {
    className: "gsb-val",
    onClick: () => removeChip(2),
    title: "Modifier",
    role: "button"
    ...
    role: "button"
  }, "Choisir une p\xE9riode\u2026") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: query,
    ...
    key: phEx
  }, examples[phEx % examples.length])))), logged && (curStage === 'event' || curStage === 'actor') && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "gsb-skip",
    onClick: () => {
      setNotFound(false);
    ...
    type: "submit",
    "aria-label": logged ? 'Valider' : 'Lancer la démo'
