...
// Themes transverses
const THEMES = [
  { id: 't-ports',   name: 'Ports',         desc: 'Capacites, trafic, gouvernance maritime',  count: 47, color: '#2E6FB8' },
  { id: 't-mines',   name: 'Mines',         desc: 'Or, uranium, cobalt, terres rares',        count: 34, color: '#C97E2A' },
  { id: 't-jnim',    name: 'JNIM',          desc: 'Groupe djihadiste transregional',          count: 86, color: '#B83A4A' },
  { id: 't-routes',  name: 'Routes & flux', desc: 'Corridors logistiques, armes, drogues',    count: 29, color: '#6B3FA0' },
  { id: 't-energie', name: 'Energie',       desc: 'Petrole, gaz, infrastructures critiques',  count: 22, color: '#0F7A7A' },
  { id: 't-pop',     name: 'Populations',   desc: 'Ethnies, deplacements, refugies',          count: 41, color: '#2F8A6B' },
];
