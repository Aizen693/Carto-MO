...
const ZONES = [
  { id: 'sahel',        code: 'SH', name: 'Sahel',           countries: 'Mali · Burkina · Niger · Tchad · Mauritanie', events: 214, period: 'Jan-Mar 26',  status: 'active', href: '/sahel/' },
  { id: 'moyen-orient', code: 'MO', name: 'Moyen-Orient',    countries: 'Syrie · Irak · Liban · Iran',                  events: 178, period: '2005-2026',   status: 'active', href: '/moyen-orient/' },
...
const REPORTS = {
  ...
  'moyen-orient': [
    ...
    { id: 'r-mo-01',   title: 'Reconfiguration des forces chiites en Syrie', date: '12 mars 2026', pages: 36, tag: 'Synthèse' },
    { id: 'r-mo-02',   title: 'Ports du Golfe, capacité et trafic',         date: '04 mars 2026', pages: 22, tag: 'Hebdo' },
  ],
  rdc: [
    { id: 'r-cd-rap',  title: 'Rapport analytique RDC',                     date: '11 mars 2026', pages: 34, tag: 'Synthèse', href: '/rdc/rapport.html' },
    { id: 'r-cd-01',   title: 'M23 / FARDC, ligne de front Kivu',           date: '11 mars 2026', pages: 24, tag: 'Hebdo' },
  ],
  madagascar: [
    { id: 'r-mg-01',   title: 'Madagascar, sécurité côtière',              date: '09 mars 2026', pages: 19, tag: 'Note' },
  ],
  'asie-sud': [
...
const GRAPHS = {
  sahel: [
    { id: 'g-sh-01', title: 'Frontière Mali-Guinée, densité d\'évts', type: 'Heatmap',     scope: '90 jours' },
    { id: 'g-sh-02', title: 'Frontière Côte d\'Ivoire-Mali, flux',    type: 'Flow',        scope: '90 jours' },
    { id: 'g-sh-03', title: 'Casualties par acteur · Q1 2026',         type: 'Histogramme', scope: 'Trimestre' },
  ],
  'moyen-orient': [
    { id: 'g-mo-01', title: 'Trafic maritime Détroit d\'Ormuz',   type: 'Timeline',  scope: '12 mois' },
...
// Themes transverses
const THEMES = [
  { id: 't-ports',   name: 'Ports',         desc: 'Capacités, trafic, gouvernance maritime',  count: 47, color: '#2E6FB8' },
...
const THEME_DETAIL = {
  ...
  't-ports': [
    ...
    { id: 'p-2', title: 'Trafic comparé · 24 mois',          type: 'Graph',   meta: '12 ports' },
  ],
  't-mines': [
    { id: 'm-1', title: 'Sahel, sites aurifères',  type: 'Carte',   meta: '78 sites', href: '/sahel/' },
    { id: 'm-2', title: 'Flux et acteurs (Sahel)',  type: 'Rapport', meta: '42 pages' },
  ],
};

Object.assign(window, { ZONES, REPORTS, GRAPHS, THEMES, THEME_DETAIL });
