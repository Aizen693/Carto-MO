...
function useVeille() {
  ...
  useEffect(() => {
    ...
    const tenterComplet = () => {
      try {
        ...
        c.auth.getSession().then(({
          ...
          if (!jwt) {
            if (on) setComplet(false);
            return;
          }
          const lang = document.documentElement.lang === 'en' ? '?lang=en' : '';
          return fetch(VEILLE_COMPLET + lang, {
            cache: 'no-store',
            headers: {
    ...
    const onState = e => {
      if (e && e.detail && e.detail.loggedIn) tenterComplet();else if (on) setComplet(false);
    };
    ...
    return () => {
      ...
      window.removeEventListener('algorAuthReady', tenterComplet);
    };
  }, []);
  return {
    items,
...
function GetSection() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    intro: "Trois temps pour passer de la donn\xE9e \xE0 la d\xE9cision : cartographier la situation, l'analyser, puis en tirer une appr\xE9ciation."
  }), /*#__PURE__*/React.createElement("div", {
    className: "get-grid"
    ...
    d: "M5 3.5v11l10-5.5z"
  })), "Survolez pour l'aper\xE7u")), /*#__PURE__*/React.createElement("div", {
